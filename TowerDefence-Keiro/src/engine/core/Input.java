...
public class Input 
{
	...
	private static boolean[] m_downKeys = new boolean[NUM_KEYS];
	private static boolean[] m_downMouse = new boolean[NUM_MOUSEBUTTONS];
	
	public static void update()
	{
		for(int i = 0; i < NUM_KEYS; i++)
			m_downKeys[i] = keyDown(i);
		
		for(int i = 0; i < NUM_MOUSEBUTTONS; i++)
			m_downMouse[i] = mouseDown(i);
	...
	{
		return keyDown(keyCode) && !m_downKeys[keyCode];
	}
	...
	{
		return mouseDown(mouseButton) && !m_downMouse[mouseButton];
	}
